...
replace (
	...
	// v0.0.0-20201204113800-737e2c461a29 -> k8s v1.17.15
	...
	k8s.io/client-go => github.com/cilium/client-go v0.0.0-20201216205127-c2dea4d25754
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.17.16-rc.0
